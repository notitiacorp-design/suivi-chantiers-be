  ...
  return useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        // Si chargÃ© d'affaires, filtrer ses chantiers
...
// Hook pour un chantier spÃ©cifique
...
// Hook pour les tÃ¢ches d'un chantier
...
export function useNotifications() {
  ...
  const markAllAsRead = useMutation({
    mutationFn: async () => {
      if (!profile) throw new Error('Profil non chargÃ©')
...
// Hook pour les stats d'un chargÃ© d'affaires
export function useChargeAffairesStats(chargeId?: string) {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      if (!targetId) throw new Error('ID du chargÃ© d\'affaires requis')
...
export function useChargesTravail() {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      try {
        // RÃ©cupÃ©rer toutes les tÃ¢ches en cours ou Ã  faire
...
// Hook pour rafraÃ®chir le health score
